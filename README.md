...
***A bug crept in to version 1.10.0 where the black/logo screen buttons stopped working. This version fixes that.***
...
system only. Download the current ProjectOn installer (v.1.10.1) and run
it on your computer.
